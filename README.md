...
```shell
git clone https://github.com/Samba-Lab/codigoergosum
```
...
5) Build a local version of your site by executing `hugo server`. You can see the site by navigating to `http://localhost:1313/codigoergosum/` (actual URL will be outputted in the CLI) in a browser.
...
links:
  - github: https://github.com/Samba-Lab/codigoergosum
  - link: https://github.com/Samba-Lab/codigoergosum#readme
...
`https://Samba-Lab.github.io/codigoergosum`